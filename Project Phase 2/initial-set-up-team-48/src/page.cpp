...
Page::Page(string tableName, int pageIndex)
{
    ...
    logger.log("Column count of page: " + to_string(this->columnCount));
    uint maxRowCount = table.maxRowsPerBlock;

    logger.log("max row count " + to_string(maxRowCount));
...
Page::Page(string tableName, int pageIndex, vector<vector<int>> rows, int rowCount)
{
    ...
    this->pageName = "../data/temp/" + this->tableName + "_Page" + to_string(pageIndex);
    logger.log("Page created " + pageName);
}
...
void Page::writePage()
{
    ...
    logger.log("Rows: " + to_string(this->rowCount) + " Col: " + to_string(this->columnCount));
