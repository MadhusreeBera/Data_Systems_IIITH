...
class BufferManager{
    ...
    Page insertIntoPool(string tableName, int pageIndex, bool isMatrix);
    ...
    Page getPage(string tableName, int pageIndex, bool isMatrix);
    ...
    void renameFile(string oldtableName, string newtablename, int pageIndex);
    void removeFromPool(string pageName, int pageIndex);
    void flushPool();
};